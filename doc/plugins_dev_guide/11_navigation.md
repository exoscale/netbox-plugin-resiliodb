...
* Attribute: link
  * Required: Yes
  * Description: Name of the URL path to which this menu item links
* Attribute: link_text
  * Required: Yes
  * Description: The text presented to the user
* Attribute: permissions
  * Required: -
  * Description: A list of permissions required to display this link
* Attribute: staff_only
  * Required: -
  * Description: Display only for users who have is_staff set to true (any specified permissions will also be required)
* Attribute: buttons
  * Required: -
  * Description: An iterable of PluginMenuButton instances to include
