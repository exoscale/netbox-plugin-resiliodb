    ...
    default_types = [
        ...
        },
        {
            ...
            'default_payload': {
                ...
                "usage": {"power_watt": 900, "duration_of_use_hour": 1, "geography": "Switzerland"}
            }
        },
        {
            'name': 'Rack Server',
        ...
        },
        {
            ...
            'default_payload': {
                ...
                "port_number": 42,
                "rack_unit": 1,
                "usage": {"duration_of_use_hour": 1, "geography": "Switzerland"}
            }
        },
        {
            'name': 'Laptop',
            ...
            'default_payload': {
                ...
                "screen_type": "LCD",
                "screen_size": 14.5,
                "usage": {"power_watt": 30, "geography": "Switzerland", "duration_of_use_hour": 1}
            }
        },
        {
            'name': 'Storage System',
        ...
        },
        {
            ...
            'default_payload': {
                ...
                "screen_format": "16/9",
                "screen_type": "LCD",
                "usage": {"power_watt": 50, "duration_of_use_hour": 1, "geography": "Switzerland"}
            }
        },
        {
            'name': 'Television',
        ...
        },
        {
            ...
            'default_payload': {
                ...
                "hdd_disks": {"quantity": 1},
                "dedicated_graphics_cards": [{"die_surface_mm2": 200, "litho_nm": 22}],
                "usage": {"power_watt": 77, "duration_of_use_hour": 1, "geography": "Switzerland"}
            }
        },
        {
            'name': 'Smartphone',
            ...
            'default_payload': {
                ...
                "usage": {"power_watt": 15, "duration_of_use_hour": 1, "geography": "Switzerland"}
            }
        },
        {
            'name': 'Tablet',
            ...
            'default_payload': {
                ...
                "usage": {"power_watt": 26, "geography": "Switzerland", "duration_of_use_hour": 1}
            }
        },
    ]
